...
public class ImageCapture : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        foreach (var file in fileInfo)
        {
            ...
            {
                Debug.LogFormat("TRADEMR: " + "Cannot delete file: ", file.Name);
            }
        }

        PhotoCapture.CreateAsync(false, this.OnPhotoCreated);

       InvokeRepeating("ExecuteImageCaptureAndAnalysis", 2, 5.0F);
    }
    ...
    /// </summary>
    public void ExecuteImageCaptureAndAnalysis() //used to be private
    {
        if (!shouldBeRunning) {
            return;
        }
    ...
    void OnCapturedPhotoToDisk(PhotoCapture.PhotoCaptureResult result)
    {
        ...
        {
            Debug.LogFormat("TRADEMR: " + "Exception capturing photo to disk: {0}", e.Message);
        }
    }
    ...
    internal void ResetImageCapture()
    {
        ...
        CancelInvoke("ExecuteImageCaptureAndAnalysis");
    }
}
